...
mixer.music.play(-1)
# Title and icon
pygame.display.set_caption("NitilA")
icon = pygame.image.load("icons/vacation.png")
pygame.display.set_icon(icon)

# player
playerImg = pygame.image.load("icons/shooter.png")
playerX = 370
playerY = 480
playerX_change = 0
...
for i in range(number_of_enemies):
    enemyImg.append(pygame.image.load("icons/balloon.png"))
...
# Bullet
# ready - bullet is inside the gun
...
while running:
    ...
    # checking for boundaries of balloon
    for i in range(number_of_enemies):
